...
class Seq2SeqDataset:
    ...
    def __init__(self, dataframe, tokenizer, max_input_length=512, max_output_length=128, **kwargs):
        self.data = dataframe
    ...
    def format_input_example(self, examples):
        ...
        if self.args.get("target") == "target_sentence_only":
            ...
            raise NotImplementedError(f"Not implemented yet for {self.args.get('target')}\nOnly target_sentence_only is supported at the moment.")
